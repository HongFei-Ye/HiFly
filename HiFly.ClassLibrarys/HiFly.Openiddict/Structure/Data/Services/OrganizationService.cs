...
public class OrganizationService<TContext, TItem>(IDbContextFactory<TContext> factory) : IOrganizationService
    where TContext : DbContext
    where TItem : class, IOrganization, new()
{
    ...
    public string GetShortNameById(string id)
    {
        ...
        var org = context.Set<TItem>().FirstOrDefault(o => o.Id == id);
    ...
    public async Task<bool> IsEnableByIdAsync(string userId)
    {
        ...
        var org = await context.Set<TItem>().FirstOrDefaultAsync(o => o.Id == userId);
